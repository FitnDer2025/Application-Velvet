    ...
    root.innerHTML = `
      <section style="min-height:100vh;padding:34px;color:#F4F4F2;background:radial-gradient(circle at 80% 0,#641b3638,transparent 30%),#0D0D0D;font-family:Inter,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif">
        <header style="display:flex;justify-content:space-between;gap:24px;align-items:flex-start;margin-bottom:26px">
          <div><p style="margin:0 0 9px;color:#C6A96A;text-transform:uppercase;letter-spacing:.18em;font-size:11px">Zwit Control · Marketing Intelligence</p><h1 style="margin:0;font:500 clamp(38px,5vw,64px)/1 Georgia,serif">Zwit Studio</h1><p style="max-width:760px;color:#c9c5c1;line-height:1.65">Crée les campagnes photo et vidéo de Zwit à partir des capacités réelles du site, avec contrôle de marque, scripts, storyboards et exports réseaux sociaux.</p></div>
        ...
        <div style="display:grid;grid-template-columns:1.15fr .85fr;gap:16px">
          <section style="border:1px solid #ffffff14;border-radius:24px;padding:22px;background:#ffffff08">
            ...
            <div style="display:grid;gap:13px">
              ...
              <label style="display:grid;gap:7px;color:#d8c69f;font-size:12px">Objectif<textarea data-vsb-objective style="min-height:90px;border:1px solid #ffffff1f;border-radius:14px;padding:12px;background:#09090b;color:white">Présenter Zwit comme la nouvelle référence premium des rencontres libres.</textarea></label>
