...
const requirements = [
  ...
  [venueCatalog.includes('control_claim_directory_venue') && venueCatalog.includes("'draft','inactive'"), 'L’attribution d’une fiche recensée ne doit pas activer automatiquement Zwit Pro'],
  ...
  [controlAuditActor.includes("'control'") && controlAuditActor.includes('audit_events_actor_type_check'), 'Les décisions Zwit Control doivent posséder un type d’audit autorisé'],
  ...
  [controlAiMediaModeration.includes("moderation_status='pending'") && controlAiMediaModeration.includes("'media_' || target_decision"), 'Zwit Control doit traiter uniquement la file ambiguë et auditer sa décision'],
  ...
  [monetizationAccessPromotions.includes("'member_discovery','Zwit Découverte'") && monetizationAccessPromotions.includes("'member_signature','Zwit Signature'"), 'Les deux niveaux Membres doivent être versionnés en base'],
  ...
  [monetizationAccessPromotions.includes("'pro_monthly_eur','EUR',3990") && monetizationAccessPromotions.includes("'pro_annual_eur','EUR',39900"), 'Les tarifs Zwit Pro validés doivent être seedés'],
  ...
  [monetizationAccessPromotions.includes('control_create_promotion') && monetizationAccessPromotions.includes('control_grant_campaign') && monetizationAccessPromotions.includes('control_manage_account'), 'Zwit Control doit piloter promotions, cohortes et comptes'],
  [monetizationAccessPromotions.includes("'Fondateurs couples · lancement'") && monetizationAccessPromotions.includes("'Fondateurs Zwit Pro · lancement'"), 'Les cohortes fondatrices doivent être préparées sans activation automatique'],
