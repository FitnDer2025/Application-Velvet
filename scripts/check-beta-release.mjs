...
const checks = [
  ...
  [pro.includes('/assets/pro-live.js'), 'Zwit Pro doit charger son workspace Supabase'],
...
console.log(`Zwit BETA release gate passed: ${checks.length} contrôles de publication`);
