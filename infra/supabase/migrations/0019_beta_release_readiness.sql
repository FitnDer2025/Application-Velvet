-- Velvet BETA — contrôles de préparation à une recette avec de vrais testeurs.
-- Les résultats sont calculés sur la source de vérité Supabase et réservés à Control.
...
revoke all on function public.control_beta_release_checks() from public, anon;
grant execute on function public.control_beta_release_checks() to authenticated;
