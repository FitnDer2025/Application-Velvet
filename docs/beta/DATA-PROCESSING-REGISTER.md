...
| Contrôle technique des photos | nombre de personnes, visage visible, cadrage à mi-corps, netteté, résultat et score de confiance | Vérifier les critères d’admission et protéger la communauté | Velvet Intelligence et, en cas de doute, modération habilitée | Résultat lié au média ; fichier supprimé au retrait |
