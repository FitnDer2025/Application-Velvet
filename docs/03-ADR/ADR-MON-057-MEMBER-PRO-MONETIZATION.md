# ADR-MON-057 — Offres Zwit Découverte, Signature et Pro

- **Statut :** Acceptée
- **Date :** 2026-07-30
- **Décideur :** Cyril GAY
- **Domaine :** Monétisation / Accès / Zwit Control
...
- **Zwit Découverte**, gratuit et réellement utilisable ;
- **Zwit Signature**, accès complet payant.

Découverte comprend la recherche essentielle, trois nouvelles conversations par semaine, les conversations déjà ouvertes sans limite, dix profils suivis, un essai Zwit IA et toutes les fonctions essentielles de profil, carte, événements, albums, blocage et signalement.

Signature ajoute la recherche avancée et les recherches sauvegardées, les nouvelles conversations et suivis sans limite, les alertes de connexion des profils suivis, les alertes personnalisées et vingt générations Zwit IA par mois.
...
- 30 établissements : 90 jours de Zwit Pro ;
- les bêta-testeurs existants peuvent être intégrés par Zwit Control.
...
La fiche publique factuelle d’un établissement peut rester visible gratuitement. La gestion de la fiche, du CRM et des événements nécessite Zwit Pro.
...
Le moteur de droits et le catalogue tarifaire sont indépendants du prestataire. Le parcours utilisera une page de paiement hébergée afin que Zwit ne conserve aucune donnée de carte.

Le raccordement réel reste bloqué tant que le prestataire compatible avec l’activité et les contenus de Zwit n’a pas donné son accord écrit. Verotel, CCBill et Segpay constituent la présélection opérationnelle ; aucun n’est retenu par cette ADR.
...
- aucune donnée bancaire n’est stockée par Zwit ;
