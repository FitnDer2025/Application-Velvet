...
- Les modèles transactionnels et marketing utilisent une enveloppe Zwit fixe, sans HTML arbitraire ; le marketing reste sans diffusion tant que consentement et désinscription ne sont pas opérationnels.
...
- Membres, Zwit Pro et Zwit Control proposent désormais la même action « Changer de compte » avec révocation de session et retour à la connexion.
...
- La connexion, Community, Zwit Pro et Zwit Contrôle partagent désormais les mêmes surfaces translucides, rayons, ombres, rythmes et retours tactiles.
...
- Zwit Pro et Zwit Contrôle adoptent la même barre de navigation applicative, les zones sûres des appareils et des vues adaptées aux petits écrans.
...
- Zwit Pro et Zwit Contrôle reprennent la même exigence sur les métriques, tableaux, filtres, messageries, panneaux latéraux et écrans de pilotage.
...
### ADR-MON-057 — Découverte, Signature et Zwit Pro

- Zwit Découverte conserve la recherche essentielle, trois nouvelles conversations par semaine, dix suivis, un essai IA et toutes les fonctions essentielles de sécurité.
- Zwit Signature apporte recherche avancée et sauvegardée, conversations et suivis illimités, vingt générations IA mensuelles et alertes personnalisées.
...
- Zwit Pro est préparé à 39,90 €/mois et 399 €/an, sans commission événement au lancement.
- Les cohortes fondatrices offrent 90 jours à 250 couples, 150 hommes seuls et 30 établissements.
- Zwit Control pilote droits, campagnes, codes, suspensions, blocages et suppressions différées.
...
- Codex peut conduire les évolutions Zwit de la branche jusqu'à la fusion et au déploiement sans validation intermédiaire.
...
- Zwit Activity Index, Mode Absence et indicateur de réactivité.
...
- Zwit Trips comme espace communautaire complet avant, pendant et après les voyages.
