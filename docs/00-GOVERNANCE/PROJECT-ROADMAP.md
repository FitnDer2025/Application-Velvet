...
| Voyages Zwit | 🟢 | 90 % | Espace communautaire complet avant, pendant et après le voyage. |
...
| IA Zwit | 🟡 | 80 % | Historique des décisions, seuils média et mode Observation pilotables ; gouvernance des futurs agents restante. |
...
- ADR-038 à ADR-041 : outils professionnels, IA métier et Zwit Trips.
...
2. IA Zwit — gouvernance et contrôles
